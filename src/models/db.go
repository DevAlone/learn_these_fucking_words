...
type User struct {
	Id       uint64 `json:"id"`
	Username string `sql:",type:varchar(32),unique,notnull" json:"username"`
...
type Language struct {
	...
	Code  string  `sql:",type:varchar(32),unique,notnull" json:"code"`
	Words []*Word `json:"words,omitempty"`
}

type Word struct {
	Id               uint32    `json:"id,omitempty"`
	Word             string    `sql:",notnull,unique:word__language_id" json:"word,omitempty"`
	LanguageId       uint16    `sql:",notnull,unique:word__language_id" json:"languageId,omitempty"`
